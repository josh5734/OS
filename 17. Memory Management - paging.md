...
6) TODO: offset 정보는(?)  --> 교수님께 여쭤보니 offset 정보는 그대로 copy된다고 한다. Paging의 중요한 개념은 각 page가 frame에 어떻게 대응되느냐가 중요한 것이라고 하셨다.
---
...
* 따라서 이렇게 큰 페이지 테이블들을 다 들고 다닐 수 없으니까 이를 해결하고자 하는 몇 가지 방법이 시도된다.
...
* Paging 개념은 중요하니까 나중에 부족한 부분을 또 채워서 정리하면 좋을 것 같다.
